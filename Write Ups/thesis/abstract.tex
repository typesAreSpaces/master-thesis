\begin{abstract}
  This thesis discusses algorithms for the uniform interpolation problem and presents implementations for the following theories: (quantifier-free) equality with uninterpreted
