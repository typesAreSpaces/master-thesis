...
data_mathsat = parse_info_chunks([
    "results/mathsat_results.txt",
    "results/mathsat_results_0.txt",
    "results/mathsat_results_1.txt",
    "results/mathsat_results_2.txt",
    "results/mathsat_results_3.txt",
    "results/mathsat_results_4.txt",
    "results/mathsat_results_5.txt",
    "results/mathsat_results_6.txt",
    ], np.zeros(num_tests, dtype=float), num_tests)
data_octi = parse_info_chunks([
    "results/thci_results_0.txt",
    "results/thci_results_1.txt",
    "results/thci_results_2.txt",
    "results/thci_results_3.txt",
    ],np.zeros(num_tests, dtype=float), num_tests)
...
plt.savefig("results/thci_performance_graph_large.png")
