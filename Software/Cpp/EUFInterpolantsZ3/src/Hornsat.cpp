...
void Hornsat::conditionalElimination(){
...
void Hornsat::conditionalReplacement(){
  // Approach: We might need to 
  // bring also equations. The above 
  // (substitutions) might be a good 
  // source of ideas
  throw "Not implemeted yet!";
}
